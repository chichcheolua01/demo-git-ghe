    ...
    <div class="grid grid-cols-8 relative">
        ...
        <div class="col-span-8 md:pl-[101px] lg:pl-[218.95px]">
            ...
            <div class="p-[36px]">
                <table class="w-full">
                    <thead>
                        <tr class="text-white grid grid-cols-7">
                            ...
                            <th class="bg-[#5B5B5B] px-[10px] py-[12px] border border-gray-800 justify-start flex">Gender</th>
                    ...
                    <tbody>
                        <tr class="grid grid-cols-7">
                            <?php foreach($users as $key => $value): ?>
                                ...
                                <td class="px-[12.5px] py-[22px]"> <?php echo $value["userGender"]; ?></td>
                                ...
                                <td class="px-[12.5px] py-[22px] flex justify-center">
                                    <div class="flex-col lg:flex-row flex space-y-3 lg:space-y-0 lg:space-x-3">
                                        ...
                                        <a href="./controller/delete-user.php?id=<?php echo $value["id"]?>"><button id="delete_user" class="px-[20px] w-full py-[10px] bg-[#AC3131] text-white rounded-lg">Delete</button></a>    
                                    </div>
                                </td>
                            <?php endforeach ?>
                        </tr>
