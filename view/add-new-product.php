                ...
                <div class="flex flex-col w-2/3">
                    ...
                    <form class="flex flex-col justify-center items-center space-y-4" action="../controller/save-add-product.php" method="POST" enctype="multipart/form-data">
                        <div class="mt-[32.5px] w-full space-y-2">
                            ...
                            <input class="border border-gray-300 px-[12px] py-[6px] w-full rounded-md" type="text" name="productName" placeholder="Nhập tên sản phẩm" value="">
                        </div>
                        <div class="mt-[32.5px] w-full space-y-2">
                            <p class="py-2">Giá sản phẩm</p>
                            <input class="border border-gray-300 px-[12px] py-[6px] w-full rounded-md" type="text" name="productPrice" placeholder="Nhập giá sản phẩm" value="">
                        </div>
                        <div class="mt-[32.5px] w-full space-y-2">
                        ...
                        <div class="mt-[32.5px] w-full space-y-2">
                            ...
                            <textarea class="border border-gray-300 px-[12px] py-[6px] w-full rounded-md" name="productDesc" id="" cols="30" rows="10"></textarea>
                        </div>
                        <div class="mt-[32.5px] w-full space-y-2">
